...
import FontSizeControl, { ARTICLE_FONT_SIZES } from "../components/article/FontSizeControl.jsx";
import ReporterBio from "../components/article/ReporterBio.jsx";
import ArticleNav from "../components/article/ArticleNav.jsx";
import PhotoCardGenerator from "../components/article/PhotoCardGenerator.jsx";
import ArticlePrintView from "../components/article/ArticlePrintView.jsx";
...
export default function Article() {
  ...
  const author = article ? getAuthorBySlug(article.author) : null;
      ...
      <div className="container-page py-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-6 pb-8">
          <article ref={articleRef} className="min-w-0">
            <ArticleHeader
              article={article}
              onOpenPhotoCard={() => setIsPhotoCardOpen(true)}
            ...
            <div className="max-w-content flex justify-end mb-3">
              <FontSizeControl sizeIndex={fontSizeIndex} onChange={setFontSizeIndex} />
            </div>

            <ArticleBody blocks={article.content} sizeClass={ARTICLE_FONT_SIZES[fontSizeIndex]} />

            <ReporterBio author={author} />
            ...
            <ArticleNav currentArticle={article} />
